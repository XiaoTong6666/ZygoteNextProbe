...
data class MountInfo(
    ...
    companion object {
        ...
        private fun makeDev(major: Int, minor: Int): Long {
            val majorBits = major.toLong()
            val minorBits = minor.toLong()
            return ((majorBits and 0xfffff000L) shl 32) or
                ((majorBits and 0xfffL) shl 8) or
                ((minorBits and 0xffffff00L) shl 12) or
                (minorBits and 0xffL)
        }
    }
}
